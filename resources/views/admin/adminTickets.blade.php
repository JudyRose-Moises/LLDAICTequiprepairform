...
<div>
    ...
    <div>
        ...
        <input type="text" id="ticketSearch" class="form-control mt-2" placeholder="Search tickets...">
    </div>
    <a href="{{ route('tickets.excelview') }}" class="btn btn-outline-success">
    View as Excel-Style Table
</a>
