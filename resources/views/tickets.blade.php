...
<div>
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
                 @php
                    $usertickets = $tickets->where('emp_number', Auth::id());
                @endphp
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="ticket-card">
                            ...
                            <small><strong>Other User/s:</strong> {{ $ticket->users }}</small><br>
    ...
    @if($ticket->status === 'working' || $ticket->status === 'nonworking')
        ...
        @else
            ...
            @else
                ...
                <a href="{{ route('rateTicket', $ticket->id) }}" class="btn btn-primary btn-sm mt-2">
                    Rate Now
                </a>
            @endif
        @endif
...
<div class="ticket-actions d-inline">
    @if($ticket->status === 'working' || $ticket->status === 'nonworking')
        <a href="{{ route('finalreport', $ticket->id) }}" class="btn btn-outline-warning btn-lg">
            Report
        </a>
    @endif
